 ...
 */
{
  "lines": {
       ...
       "vehicle": [
         { "enabled": false, "from": 20,  "to": 300, "inmeters": false, "thickness": 0.4, "alpha": 35, "color": "0xFFFFFF"}
       ],
       // Camera direction.
       // Направление камеры от своей техники.
       "camera": [
         { "enabled": true, "from": 50,  "to": 200, "inmeters": true, "thickness": 1.5,   "alpha": 60, "color": "0xFFFFFF"},
         { "enabled": true, "from": 200, "to": 300, "inmeters": true, "thickness": 1, "alpha": 45, "color": "0xFFFFFF"},
         { "enabled": true, "from": 300, "to": 800, "inmeters": true, "thickness": 0.7,   "alpha": 30, "color": "0xFFFFFF"}
       ],
